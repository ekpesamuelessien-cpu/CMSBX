        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    <h3 class="card-title"> {{optional($state)->name }} State  Members By Polling Unit</h3>
...
<script>
    $(document).ready(function() {
       $('#myPuMembers').DataTable({
           ...
           "serverSide": true,
           "searching": true,
           "ajax": "{{ route($profileData->access_level.'.members.byPu.ajax', $WardLgaStateRegionCountryUUID ?? null) }}", // Define a route to get the paginated data
