        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    <h3 class="card-title">All {{ $region->name }} Members</h3>
...
<script>
 ...
 $(document).ready(function() {
    $('#myMembers').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route($profileData->access_level.'.region.members.data', $region->uuid) }}", // Define a route to get the paginated data
