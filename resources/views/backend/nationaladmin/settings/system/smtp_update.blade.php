        ...
        <div class="row">
          <div class="col-9">
            <div class="card card-dark ">
              ...
              <h3 class="card-title">Mailer SMTP Settings</h3>
            ...
            <div class="card-body" style="display: block;">
                <form method="POST" action="{{ route('admin.settings.smtp.update') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <button type="submit" class="btn btn-dark btn-block btn-group-lg"><i class='fas fa-save' style='font-size:24px;color:white'> Save</i></button>
