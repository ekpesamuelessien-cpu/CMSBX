            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route($profileData->access_level.'.member.add') }}"><button class="btn btn-default"> <i class="fa fa-plus-square"></i> Add New Exco Member</button></a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
<script>
 $(document).ready(function() {
    $('#myMembers').DataTable({
        ...
        "serverSide": true,
        "searching": true,
        "ajax": "{{ route($profileData->access_level.'.leaders.data', $PuLgaStateRegionCountryUUID) }}", // Define a route to get the paginated data
