...
<div class="card card-primary">
              <div class="card-header">
                    <h3 class="card-title">{{$lga->name}} LGA Statistics</h3>
                            ...
                            <div class="col-lg-6 col-6">
                              ...
                              <div class="small-box bg-info">
                                ...
                                <h3>{{$wardWithUsersCount}}</h3>
                                  <p>Out of <strong>{{$wardCount}}</strong> Wards in {{$lga->name}} LGA of {{ $lga->state->name }} State </p>
                                  <p style="float: right;">
                                    <b>
                                        @php
                                            if ($wardCount > 0) {
                                ...
                                <a href="{{route($profileData->access_level.'.members.byWard', $lga->uuid)}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-6 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <h3>{{$puWithUsersCount}}</h3>
                                  <p>Out of <strong>{{$puCount}}</strong> PUs in {{$lga->name}}</p>
                                  <p style="float: right;">
                                    <b>
                                        @php
                                            if ($puCount > 0) {
                                ...
                                <a href="{{route($profileData->access_level.'.members.byPu', $lga->uuid)}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                  ...
                  <div class="row">
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="{{ route($profileData->access_level.'.peopleMetric', ['metric' => 'new-today', 'uuid' => $lga->uuid]) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-secondary">
                                ...
                                <a href="{{route($profileData->access_level.'.leaders', $lga->uuid)}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-primary">
                                ...
                                <a href="{{route($profileData->access_level.'.regulars', $lga->uuid)}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-success">
                                ...
                                <a href="{{route($profileData->access_level.'.member.lga.view', $lga->uuid)}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div> <!-- ./col -->
                  </div><!-- /.row -->
          </div> <!-- /.card-body -->
