        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    <h3 class="card-title">{{ $ward->name }} ward - {{ $ward->localGovernmentArea->name }} LGA -  {{ $ward->localGovernmentArea->state->name }} State - Members</h3>
...
<script>
    var ajaxUrl = "{{ route($profileData->access_level.'.ward.members.data', $ward->uuid) }}";
</script>
...
<script>
    $(document).ready(function() {
       $('#myMembers').DataTable({
           ...
           "serverSide": true,
           "searching": true,
           "ajax": ajaxUrl, // Define a route to get the paginated data
