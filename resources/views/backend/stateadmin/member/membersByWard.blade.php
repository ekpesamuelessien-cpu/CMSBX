        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    <h3 class="card-title"> {{optional($state)->name }} State Members By Ward</h3>
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="myWardMembers" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>S/N</th>
                                        <th>Ward</th>
...
<script>
    $(document).ready(function() {
       $('#myWardMembers').DataTable({
           "processing": true,
           "serverSide": true,
           "searching": true,
           "ajax": "{{ route($profileData->access_level.'.members.byWard.ajax', $LgaStateRegionCountryUUID ?? null) }}", // Define a route to get the paginated data
