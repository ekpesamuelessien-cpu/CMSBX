        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    <h3 class="card-title">{{ $lga->name }} LGA - {{ $lga->state->name }} State Members</h3>
...
<script>
 ...
 $(document).ready(function() {
    $('#myMembers').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route($profileData->access_level.'.lga.members.data', $lga->uuid) }}", // Define a route to get the paginated data
