            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    ...
                    @elseif($profileData->access_level == 'senatorialadmin')
                        Senatorial District Votes By PU for {{ $profileData->senatorialDistrict->name ?? 'Your Senatorial District' }}
                    @elseif($profileData->access_level == 'federaladmin')
                        Federal Constituency Votes By PU for {{ $profileData->federalConstituency->name ?? 'Your Federal Constituency' }}
                    ...
                    @elseif($profileData->access_level == 'puadmin' || $profileData->access_level == 'pollingunitadmin')
                        Polling Unit Votes By PU for {{ $profileData->pollingUnit->name ?? 'Your Polling Unit' }}
                    @endif
