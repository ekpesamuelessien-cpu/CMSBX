            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Add Senatorial District</h3>
                    ...
                    <div class="card-body">
                        <form action="{{ route($profileData->access_level.'.location.senatorial-district.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
