...
<div class="card card-primary">
              <div class="card-header">
                    <h3 class="card-title">{{$pu->name}} PU Statistics</h3>
                    ...
                    <div class="col-lg-6 col-6">
                              ...
                              <div class="small-box bg-primary">
                                ...
                                <h3>{{$eligibleVotersCount}}</h3>
                                  <p>Eligible Voters in {{$pu->name}} PU</p>
                                  <p style="float: right;">
                                    <b>
                                        @php
                                            if ($userCount> 0) {
                                ...
                                <a href="{{ route($profileData->access_level.'.eligible.members.byPu', $pu->uuid) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                    </div>
                    <!-- ./col -->
                    ...
                    <div class="col-lg-6 col-6">
                        ...
                        <div class="small-box bg-danger">
                          ...
                          <h3>{{$inEligibleVotersCount}}</h3>
                            <p>Ineligible voters in {{$pu->name}} PU</p>
                            <p style="float: right;">
                              <b>
                                  @php
                                      if ($userCount> 0) {
                  ...
                  <div class="row">
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="{{ route($profileData->access_level.'.peopleMetric', ['metric' => 'new-today', 'uuid' => $pu->uuid]) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                            ...
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-primary">
                                ...
                                <a href="{{route($profileData->access_level.'.regulars', $pu->uuid)}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-success">
                                ...
                                <a href="{{route($profileData->access_level.'.member.pu.view', $pu->uuid)}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div> <!-- ./col -->
                  </div><!-- /.row -->
...
<script>
    ...
    function updatePieChart() {
        $.ajax({
            url:"{{route($profileData->access_level.'.pu.member.distribution.gender', $pu->uuid)}}", // Ensure URL is a string
            method: 'GET',
...
<script>
    ...
    function updateValidVoterPieChart() {
        $.ajax({
            url: "{{route($profileData->access_level.'.pu.member.distribution.voter', $pu->uuid)}}", // Update with your route URL
            method: 'GET',
            success: function(data) {
