        ...
        <div class="row">
          <div class="col-9">
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form class="form" action="{{route($profileData->access_level.'.product.category.store')}}" method="POST" >
                @csrf
                        ...
                        <div class="col-3">
                        <button type="submit" class="btn btn-primary btn-block btn-group-lg">Add Category</button>
                        </div>
              </form>
