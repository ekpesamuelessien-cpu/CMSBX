        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <div class="card-header">
                    <h3 class="card-title">{{ $state->name }} State Members</h3>
...
<script>
            $(document).ready(function() {
                $('#myMembers').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "{{ route($profileData->access_level.'.state.members.data', $state->uuid) }}", // Define a route to get the paginated data
                    ...
                    "columns": [
                        ...
                        { "data": "name" },
                        { "data": "access_level" },
                        { "data": "Voter_status", "name": "Voter_status" },
