            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="{{route($profileData->access_level.'.settings.export.permission')}}"><button class="btn btn-dark"> <i class="fa fa-file-excel"></i> Download Excel File</button></a>
              ...
              <!-- form start -->
              <form class="form" action="{{route($profileData->access_level.'.settings.import.permission.data')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
