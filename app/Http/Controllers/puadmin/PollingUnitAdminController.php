...
namespace App\Http\Controllers\puadmin;
...
class PollingUnitAdminController extends Controller
{
    ...
    public function puAdminDashBoard()
    {
        $pageTitle    = 'Polling Unit Dashboard';
        $profileData  = $this->getProfileData();

        if($profileData->access_level == 'puadmin') {
            $pu = PollingUnit::where('id', $profileData->polling_unit_id)->first();
        } else {
            abort(403);
        }

       
          // Get the count of users in pu
        $UsersCount = User::where('polling_unit_id', $pu->id)->count();
    ...
    public function puAdminProfile()
    {
            $profileData = $this->getProfileData();
            $pageTitle = 'Profile';
      ...
      public function puAdminProfileStore(Request $request)
      {
          $profileData = $this->getProfileData();
    ...
    public function puAdminChangePassword()
    {
    ...
    public function puAdminUpdatePassword(Request $request)
    {
